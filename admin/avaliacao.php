          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              $.each(response, function (index, item) {
                ...
                newRow.append("<td  class='" + nivelLiderClass + " text-end'><span class='me-2'>" + getStarString(nivel_lider) + "<br class='empurra d-none d-sm-block d-md-none'></span>" + participante1 + " </td>");
                newRow.append("<td  class='" + nivelOutrosClass + " text-end'> <span class='me-2'>" + getStarString(nivel_outros) + "</span><br class='empurra d-none d-sm-block d-md-none'>" + outros_participantes + "</td>");
