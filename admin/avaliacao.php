                ...
                for (let i = 0; i < row.participantes.length; i++) {
                  ...
                  if (row.participantes[i].nome !== null) {
                    tabelaEnvios.append(`
                      ...
                      <button type="button" class="btn btn-outline-success btn-sm enviar_link" data-participant-id="${row.participantes[i].id}"><span class="btn-label"><i class="fa fa-paper-plane me-2"></i></span>Enviar</button>
                      </td>
                      </tr>
                      `);
                  }
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              $.each(response, function (index, item) {
                ...
                newRow.append("<td  class='" + nivelLiderClass + " text-end'><span class='me-2'>" + getStarString(nivel_lider) + "</span>" + participante1 + " </td>");
                newRow.append("<td  class='" + nivelOutrosClass + " text-end'> <span class='me-2'>" + getStarString(nivel_outros) + "</span>" + outros_participantes + "</td>");
